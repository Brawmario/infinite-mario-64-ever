...
/** @type {string} */
const CACHE_VERSION = '1768352988|3615127';
/** @type {string} */
const CACHE_PREFIX = 'Infinite Mario 6-sw-cache-';
...
/** @type {string[]} */
const CACHABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libdd3d.web.template_release.wasm32.threads.wasm","libsm64gd.web.template_release.wasm32.wasm"];
